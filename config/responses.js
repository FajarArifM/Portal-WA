...
function formatWithHeaderFooter(message) {
    const COMPANY_HEADER = process.env.COMPANY_HEADER || "📱 PT MULTI NETWORK SOLUTIONS 📱\n\n";
    const FOOTER_SEPARATOR = "\n\n━━━━━━━━━━━━━━━━━━━━━━\n";
    const FOOTER_INFO = FOOTER_SEPARATOR + (process.env.FOOTER_INFO || "Powered by 3ANGEL.NET - BOJONEGORO");
