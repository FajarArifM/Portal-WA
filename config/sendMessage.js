...
function getHeaderFooter() {
    try {
        ...
        return {
            header: settings.company_header || '3ANGEL.NET BOT MANAGEMENT',
            footer: settings.footer_info || 'Internet Unlimited'
        };
    } catch (error) {
        return {
            header: '3ANGEL.NET BOT MANAGEMENT',
            footer: 'Internet Unlimited'
        };
    }
}
